...
def accueil(image_accueil, ecran_du_jeu, police_titre, police_texte, BLANC, ROUGE, GRIS, DORE, bouton_jouer, son_menu):
    ...
    pygame.draw.rect(ecran_du_jeu, GRIS, bouton_jouer, border_radius=10)
