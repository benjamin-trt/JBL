...
def fin(ecran_du_jeu, police_titre, police_retour, police_sortie, police_rejouer, score, GRIS1, ORANGE, ROUGE):    
    ...
    texte_retour = police_retour.render("Z : menu", True, ROUGE)
    texte_sortie = police_sortie.render("A : quitter", True, ROUGE)
    texte_rejouer = police_rejouer.render("ENTREE : rejouer", True, ROUGE)
